...
![](images/join-outer.png){width="302"}
...
### [**Exercise for Self Learning**]{style="color:coral"}

[1. For the `new_splicing_data`, select Events with PSI_value below 0.5]{style="color:coral"}

[**Exercise: for below splicing data**]{style="color:coral"}

[1. **Select Events with PSI_value below 0.5**]{style="color:coral"}

[2. **For found Events, find sum and mean values for each groups where these Events are**]{style="color:coral"}
